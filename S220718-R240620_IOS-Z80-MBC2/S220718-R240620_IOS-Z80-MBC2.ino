...
#include <stdlib.h>                       // might need this for BDTimer
#include <string.h>                       //  ""  
...
// QDTimer -- Quick and Dirty Timer Hack by D. Collins 2020
char          timerstring[11];            // this is the character array we save the string value in.
int           tslength;                   // how long is the string.
    ...
    
    {
      ...
      
      {
        ...
        //
        {
          ...
          case  0x88:
            // QDTimer 
            // QDTimer - small quick and dirty timer.
            //
            //          I/O DATA 0: D7 D6 D5 D4 D3 D2 D1 D0
            //          ------------------------------------------------------------------------
            ...
            if (ioByteCnt == 0) {
                   ltoa(millis(),timerstring,10); // we save the timer to a string 
                   tslength = strlen(timerstring); // determine how long the string is
                   }

               if (ioByteCnt <= tslength)
               // Send result of millis() as character array across the bus Z80 bus
               {  
                 ioData = (int)timerstring[ioByteCnt];
                 ioByteCnt++;
               }
               else ioOpcode = 0xFF;              // All done. Set ioOpcode = "No operation"
            break;
