...
{ this is a CP/M bios only version of the graphics library,
  it only uses bios calls for the key IO features of the
  library.  This should be the most compatible version
  for use with NON-Z80 MBC computers }
...
begin
 {check to see if a character is waiting with CONST, then if
  so read that character with CONIN, If not output zero }
